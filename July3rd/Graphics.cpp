	...
	sysBuffer(ScreenWidth, ScreenHeight)
{
	...
	// create pixel shader for framebuffer . Ignore the intellisense error "namespace has no member"
	...
	// create vertex shader for framebuffer . Ignore the intellisense error "namespace has no member"
...
void Graphics::DrawFlatBottomTriangleTex(const TexVertex& v0, const TexVertex& v1, const TexVertex& v2, const Surface& tex)
{
	...
	// create right edge interpolants
