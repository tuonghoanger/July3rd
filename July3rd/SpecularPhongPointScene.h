...
struct PointDiffuseParams	// diffuse light
{
...
struct SpecularParams	// Specular light
{
...
public:
		...
		Scene("phong point shader scene free mesh")
	{
		...
		walls.push_back({ 	// default plane face toward camera   ,    left to right multiply matrix
			&tCeiling,
